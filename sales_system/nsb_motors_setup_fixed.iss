...
; Install to C:\NSBMotors to completely avoid any space issues
DefaultDirName=C:\NSBMotors
DisableProgramGroupPage=yes
LicenseFile=LICENSE
PrivilegesRequired=admin
OutputDir=.
OutputBaseFilename=nsb_motors_system_setup_simple
Compression=lzma
...
[Registry]
Root: HKLM; Subkey: "SOFTWARE\NSB Motors\System"; ValueType: string; ValueName: "InstallPath"; ValueData: "{app}"; Flags: uninsdeletekey
