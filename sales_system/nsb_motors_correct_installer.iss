; NSB Motors System Installer (Corrected)
; Inno Setup Script
...
OutputDir=.
OutputBaseFilename=nsb_motors_system_correct_installer
Compression=lzma
...
[Files]
Source: "installer_temp\app\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
